...
function Search(props) {
    ...
    return (
        <div className='container'>
            ...
            <input className='w-100 inp common_b_radius' placeholder="ex: Milano" onChange={(e)=>handleChangeCity(e)}></input>
            <button className='btn_search' onClick={()=>props.setCity(city)}>
